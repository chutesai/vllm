...
async def init_generate_state(
    ...
    # Add chutes-specific kwargs to the chat kwargs dict
    _chat_kwargs["log_error_stack"] = args.log_error_stack
    _chat_kwargs["max_completion_tokens"] = args.max_completion_tokens
    _chat_kwargs["max_stream_completion_tokens"] = args.max_stream_completion_tokens
    _chat_kwargs["enable_return_hidden_states"] = args.enable_return_hidden_states
    state.openai_serving_chat = (
        OpenAIServingChat(**_chat_kwargs)
