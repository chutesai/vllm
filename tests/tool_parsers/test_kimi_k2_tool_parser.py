...
# ============================================================
# HEAD-only tests using kimi_k2_tool_parser fixture and
# run_streaming_sequence helper (chutes-specific regression tests)
# ============================================================
...
def test_extract_tool_calls_parametrized(
...
def test_empty_tool_section_standalone(kimi_k2_tool_parser):
...
def test_multi_turn_native_id_continuity_standalone(
    kimi_k2_tool_parser, kimi_k2_tokenizer
):
    """Regression: native IDs from turn 1 preserved across turns (PR #32768)."""
    turn1_output = (
        "Let me check. "
